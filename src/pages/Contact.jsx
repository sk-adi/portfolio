        ...
        <div className="md:w-1/2 px-10 md:px-28 ">
          ...
          >
            ...
            <textarea
              ...
              placeholder="Message"
            ></textarea>
            <div className="  hover:text-black text-xl md:text-2xl md:font-bold tracking-widest md:tracking-normal px-4 py-2 sm:px-4 sm:py-2 md:pt-2 md:px-2  relative overflow-hidden before:absolute  before:left-0 before:bottom-[0] before:w-full before:h-[3px] hover:before:h-full before:bg-[#FF4D5A]  before:transition-all before:duration-300 hover:before:z-[-1]">
            <input
